...
} from '@core/usecase/CreateProjectUseCase';
import {
    AddCoverToProjectCommand,
    AddCoverToProjectUseCase,
} from '@core/usecase/AddCoverToProjectUseCase';
...
export const configureProjectRouter = (
    ...
    router.get('/:id', async (req: Request, res: Response) => {
        ...
        const project =
            await getProjectByProjectID.getProjectByProjectID(projectId);
    ...
    router.post(
        ...
        async (req: Request, res: Response) => {
            ...
            const command = new AddCoverToProjectCommand(
                req.params.id,
                media,
                title,
            );
